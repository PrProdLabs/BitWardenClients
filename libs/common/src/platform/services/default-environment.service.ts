...
export const PRODUCTION_REGIONS: RegionConfig[] = [
  {
    key: Region.US,
    domain: "vault.principalprod.fr",
    urls: {
      base: "https://vault.principalprod.fr",
      api: "https://vault.principalprod.fr/api",
      identity: "https://vault.principalprod.fr/identity",
      icons: "https://vault.principalprod.fr/icons",
      webVault: "https://vault.principalprod.fr",
      notifications: "https://vault.principalprod.fr/notifications",
      events: "https://vault.principalprod.fr/events",
      scim: null,
    },
  },
];
